...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="home.php">LifeLine Forum</a>
            </div>
    ...
    <div class="container" style="margin:7% auto;">
       <div> <div class="banner-breadcum section">
<div class="row">
    ...
    <div class="container text-center">
        <h1>Frequently asked questions</h1>
            <div class="breadcrumbs_path">
                <a href="#">Home</a>  -   Latest Discussion
            </div>      
    </div>
</div>
    </div>
</div></div>
    	<h1><center>Latest Discussion</center></h1>
    	<hr>
